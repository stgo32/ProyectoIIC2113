...
public class Player
{
    ...
    public int GetNumberOfCardsInArsenal() { return _arsenal.Count(); }
    ...
    {
        Card card = DrawCardFromPossibleCardsToRingAreaById(cardId);
    ...
    {
        return DrawCardFromArsenalToRingside();
    }
